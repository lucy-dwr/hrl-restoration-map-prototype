...
- **Bottom tile strip.** Headline progress tiles currently show visible project count and total submitted acreage where available. Confirmed position: bottom-centre of the map area (Decision 22). Avoids conflict with the left layer panel and bottom-right navigation controls.
